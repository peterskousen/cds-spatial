...
wcdata <- wc %>% 
  ...
  summarize(flatsum = sum(flats), #total number of flats by suburb
            bathsum = sum(bath), #total number of baths by suburb
            pct_bath = bathsum/flatsum*100, #percentage of flats with baths in a suburb
            wc_access= sum(wc_access),  #total number of toilets by suburb
            pct_wc=  wc_access/flatsum*100, #percentage of flats with toilets in a suburb
            warmH20= sum(hot_water),    #total number of hot water taps by suburb
            pct_wH20= hot_water/flatsum*100,  # percentage of flats with hot water taps
